...
describe('ContextFacet', () => {
    it('should render the highest label of context hierarchy', () => {
        ...
        render(<CustomizedTreeView label={"Context"} value={[]} expanded={["Any sampled feature", "Active human occupation site"]} facetValues={["Any sampled feature", "Active human occupation site"]} facetCounts={[1000,100]} hierarchy={mockedHierarchyFunc} renderZeroCount={true}/>);
